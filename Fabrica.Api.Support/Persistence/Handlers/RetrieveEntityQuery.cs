...
public abstract class RetrieveEntityQuery<TRequest,TEntity>(IQueryService service) : CorrelatedObject(service.Correlation), IRequestHandler<TRequest, Response<TEntity>> where TRequest : BaseRetrieveEntityRequest<TEntity> where TEntity : class, IEntity
{
